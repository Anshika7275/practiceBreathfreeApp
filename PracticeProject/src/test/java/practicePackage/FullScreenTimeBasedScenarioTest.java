...
public class FullScreenTimeBasedScenarioTest extends BaseClass2{
	...
	public void healthCheckIns_SkipTest()
	{
		...
		WebElement dropdowns1 = wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath(
...
//		option1.click();
		...
		//Second question
		WebElement dropdowns2 = wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath(
	    ...
	    //Wait for options list & select value
		By valueLocator1 = AppiumBy.xpath("//android.widget.TextView[@text='5']");

		

		for (int i = 0; i < 5; i++) {
		    try {
		        WebElement value1 = wait.until(
		...
		//third question
		WebElement dropdowns3 = wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath(
		...
		// fourth question
		WebElement dropdowns4 = wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath(
		...
		// Fifth question
		WebElement dropdowns5 = wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath(
